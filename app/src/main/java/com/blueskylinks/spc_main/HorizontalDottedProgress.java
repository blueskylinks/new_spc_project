...
public class HorizontalDottedProgress extends View{
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        for(int i = 0; i < mDotAmount; i++ ){
            if(i == mDotPosition){
                canvas.drawCircle(50+(i*20), mBounceDotRadius, mBounceDotRadius, paint);
            }else {
                canvas.drawCircle(50+(i*20), mBounceDotRadius, mDotRadius, paint);
            }
        }
